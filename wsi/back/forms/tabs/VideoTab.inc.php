<div id="tab_video">
	<table>
		<tr id="box_youtube" class="box_type">
			...
			<td>
				<input type="text" name="wsi_youtube" value="<?php echo $siBean->getWsi_youtube(); ?>" />
				&nbsp;&nbsp;&nbsp;
		...
		<tr id="box_yahoo" class="box_type">
			...
			<td><input type="text" name="wsi_yahoo" value="<?php echo $siBean->getWsi_yahoo(); ?>" /></td>
		</tr>
		<tr id="box_dailymotion" class="box_type">
			...
			<td><input type="text" name="wsi_dailymotion" value="<?php echo $siBean->getWsi_dailymotion(); ?>" /></td>
		</tr>
		<tr id="box_metacafe" class="box_type">
			...
			<td><input type="text" name="wsi_metacafe" value="<?php echo $siBean->getWsi_metacafe(); ?>" /></td>
		</tr>
		<tr id="box_swf" class="box_type">
			...
			<td><input size="70" type="text" name="wsi_swf" value="<?php echo $siBean->getWsi_swf(); ?>" /></td>
		</tr>
	</table>
</div>